const { client, getAllUsers, createUser, updateUser, createPost, getUserById, updatePost, getAllPosts, getPostsByUser } = require('./index');
...
async function createTables() {
    try {
        ...
        await client.query(`
            ...
            CREATE TABLE posts (
                id SERIAL PRIMARY KEY,
                "authodId" INTEGER REFERENCES users(id),
